...
namespace DL_EF
{
    ...
    public partial class DAguirreLibroEntities1 : DbContext
    {
        public DAguirreLibroEntities1()
            : base("name=DAguirreLibroEntities1")
        {
        }
        ...
        public virtual int LibroAdd(string nombre, Nullable<int> idAutor, Nullable<int> numeroPaginas, string fechaDePublicacion, Nullable<int> idEditorial, string edicion, Nullable<int> idGenero)
        {
            ...
            var fechaDePublicacionParameter = fechaDePublicacion != null ?
                new ObjectParameter("FechaDePublicacion", fechaDePublicacion) :
                new ObjectParameter("FechaDePublicacion", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("LibroAdd", nombreParameter, idAutorParameter, numeroPaginasParameter, fechaDePublicacionParameter, idEditorialParameter, edicionParameter, idGeneroParameter);
        }
        ...
        public virtual int LibroUpdate(Nullable<int> idLibro, string nombre, Nullable<int> idAutor, Nullable<int> numeroPaginas, string fechaDePublicacion, Nullable<int> idEditorial, string edicion, Nullable<int> idGenero)
        {
            var idLibroParameter = idLibro.HasValue ?
                new ObjectParameter("IdLibro", idLibro) :
                new ObjectParameter("IdLibro", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("LibroUpdate", idLibroParameter, nombreParameter, idAutorParameter, numeroPaginasParameter, fechaDePublicacionParameter, idEditorialParameter, edicionParameter, idGeneroParameter);
        }
